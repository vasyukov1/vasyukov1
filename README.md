...
[Сервис для стриминга и селфхостинга музыки](https://github.com/vasyukov1/Timshel-Music-Term-Paper) | Курсовая работа | iOS-приложение для прослушивания музыки, загруженное на свой собственный сервер. | Swift, UIKit, Foundation, AVFoundation, Network, Combine
[BlesBook](https://github.com/vasyukov1/Blesbook) | Android | Android-приложение для учёта книг и цитат. | Kotlin, Gradle 
